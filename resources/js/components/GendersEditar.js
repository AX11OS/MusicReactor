...
export default GendersEditar;

if (document.getElementById('genderseditar')) {
    ReactDOM.render(<GendersEditar />, document.getElementById('genderseditar'));
}
